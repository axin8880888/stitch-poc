...
object RawToJpegPipeline {
    ...
    // RGB→XYZ ColorMatrix (D65) — 基于808样片精校V2
    private val NOKIA_COLOR_MATRIX = floatArrayOf(
        0.780000f, 0.260000f, -0.010000f,
        -0.120000f, 0.900000f, 0.080000f,
        -0.010000f, 0.015000f, 0.680000f,
    )

    // XYZ→RGB ForwardMatrix — 诺基亚暖调偏移
    private val NOKIA_FORWARD_MATRIX = floatArrayOf(
        1.100000f, -0.350000f, -0.100000f,
        -0.200000f, 1.150000f, 0.120000f,
        0.030000f, -0.250000f, 0.800000f,
    )
